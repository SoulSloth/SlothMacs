...
#+RESULTS:
: ((dot . src dot :file dotDiagram.png :exports both) (d . src dockerfile) (js . src js) (pl . src plantuml :file diagram.png) (conf . src conf) (yl . src yaml) (clj . src clojure) (go . src go :imports `("fmt")) (py . src python :results output) (el . src emacs-lisp) (sh . src shell) (a . export ascii) (c . center) (C . comment) (e . example) (E . export) (h . export html) (l . export latex) (q . quote) (s . src) (v . verse))
