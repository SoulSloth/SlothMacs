...
#+RESULTS:
| dashboard-mode | messages-buffer-mode | edebug-mode | woman-mode | Man-mode | lsp-ui-imenu-mode | view-mode | Custom-mode | apropos-mode | ediff-mode | bookmark-bmenu-mode | eww-bookmark-mode | eww-buffers-mode | eww-history-mode | eww-mode | speedbar-mode | gnus-summary-mode | gnus-server-mode | gnus-group-mode | gnus-browse-mode | gnus-bookmark-bmenu-mode | gnus-article-mode | doc-view-mode | cider-stacktrace-mode | archive-mode | arc-mode | vc-git-log-view-mode | outline-mode | calendar-mode | xref--transient-buffer-mode | xref--xref-buffer-mode | tabulated-list-mode | tab-switcher-mode | package-menu-mode | occur-mode | git-commit-mode | magit-gitflow-mode | magit-blob-mode | magit-status-mode | magit-stashes-mode | magit-stash-mode | magit-revision-mode | magit-refs-mode | magit-reflog-mode | magit-process-mode | magit-log-select-mode | magit-log-mode | magit-diff-mode | magit-cherry-mode | magit-mode | git-rebase-mode | magit-submodule-list-mode | magit-repolist-mode | Info-mode | image-mode | ibuffer-mode | help-mode | emacs-lisp-mode | diff-mode | compilation-mode | calc-mode | Buffer-menu-mode |
...
#+RESULTS:
: ((pl . src plantuml) (conf . src conf) (yl . src yaml) (clj . src clojure) (py . src python) (el . src emacs-lisp) (sh . src shell) (a . export ascii) (c . center) (C . comment) (e . example) (E . export) (h . export html) (l . export latex) (q . quote) (s . src) (v . verse))
...
** Dired defaults on Mac Darwin systems
