...
#+RESULTS:
| lsp-ui-mode | company-mode | efs/lsp-mode-setup |
...
#+RESULTS:
| lsp-deferred | #[0 \211\207 [py--imenu-create-index-function imenu-create-index-function] 2] | evil-collection-python-set-evil-shift-width | doom-modeline-env-setup-python |
...
#+RESULTS:
: ((conf . src conf) (yl . src yaml) (clj . src clojure) (py . src python) (el . src emacs-lisp) (sh . src shell) (a . export ascii) (c . center) (C . comment) (e . example) (E . export) (h . export html) (l . export latex) (q . quote) (s . src) (v . verse))
